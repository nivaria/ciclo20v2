                       ...
                       <?php if(!$is_edit): ?>  
                        <div class="block">
                          <div class="inner clearfix"> 
                              <div class="content" style="border-radius: 12px; -moz-border-radius: 12px; -webkit-border-radius: 12px;">
                                ...
                                <?php if(node_access('update', $node)){
                                 ...
                                 <?php
                                    $block_terms = module_invoke('views','block','view','8dca09a8842acd2748e82a9238b5e46f');
                                    if(!empty($block_terms['content'])){
                                        print '<div class="og-terms-container clearfix">'.$block_terms['content'].'</div>';
                                    }
                                 ?>
                                 <?php
